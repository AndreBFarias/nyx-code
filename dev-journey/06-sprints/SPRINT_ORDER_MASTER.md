...
| 125cc | **INFRA-OOM-HISTORY-01** | 24.1 Infra resiliente | BAIXA | RASCUNHO (anti-débito declarado pelo INFRA-OOM-02 — persistência cross-session do oom_recovery_count em ~/.nyx/proxy_stats.json. Touches: nyx/proxy.py handle_stats + _on_startup. Útil para auditoria longitudinal de instabilidade.) | INFRA-OOM-02 |
