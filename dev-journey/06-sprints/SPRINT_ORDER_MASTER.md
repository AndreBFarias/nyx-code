...
| 125aa | **INFRA-OOM-RETRY-STEP-01** | 24.1 Infra resiliente | BAIXA | RASCUNHO (anti-débito opcional declarado out-of-scope pelo INFRA-OOM-02 — antes de cair direto para num_gpu=0, tentar passo intermediário num_gpu // 2 ex: 12 -> 6 -> 0. Reduzir downgrade abrupto se VRAM oscilante. Touches: nyx/proxy.py handle_chat path OOM recovery, possivelmente helper _next_num_gpu_step. Avaliar custo-benefício — modelo pode rodar parcialmente em GPU se 6 caber mas 12 não.) | INFRA-OOM-02 |
