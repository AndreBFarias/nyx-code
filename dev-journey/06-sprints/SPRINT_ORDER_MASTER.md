...
| 125bb | **INFRA-OOM-STATS-CLI-01** | 24.1 Infra resiliente | BAIXA | RASCUNHO (anti-débito declarado pelo INFRA-OOM-02 — novo slash command /stats em nyx/agent/commands/ consumindo GET /admin/stats e renderizando em CLI. Touches: nyx/agent/commands/stats.py NOVO, nyx/agent/commands/__init__.py.) | INFRA-OOM-02 |
