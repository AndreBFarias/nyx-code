...
| 131 | **UX-AGENCY-02** | 23.4 Gamedesigner | ALTA | BLOQUEADA (cancel asyncio em tool em curso + footer/prefix dinamico exigem trabalho de orquestracao asyncio + validacao com REPL real -- sprint humana) | UX-AGENCY-01 |
...
| 151 | **GAMBIARRAS-ACENTUACAO-FIX-01** | 24.4 Higiene | BAIXA | CONCLUIDA (2026-05-19) | -- (achado colateral durante NYX-NO-HALLUCINATE-TOOL-01: dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md:334 "funcao" → "função"; validar-acentuacao.py exit 0; edit cirúrgico de 1 linha) |
