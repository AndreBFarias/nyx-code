...
| 179 | **TUI-REDESIGN-28-07** | 28.1 TUI paridade Claude Code | MÉDIA | CONCLUIDA (2026-05-18) | cursor blink async no banner `$ nyx.code` (~1.5s, skip em headless e NYX_NO_ANIMATION) |
