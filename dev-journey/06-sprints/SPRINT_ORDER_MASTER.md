...
| 131 | **UX-AGENCY-02** | 23.4 Gamedesigner | ALTA | BLOQUEADA (cancel asyncio em tool em curso + footer/prefix dinamico exigem trabalho de orquestracao asyncio + validação com REPL real -- sprint humana) | UX-AGENCY-01 |
| 132 | **UX-PROGRESSION-02** | 23.4 Gamedesigner | BAIXA | BLOQUEADA (refactor amplo das ~50 mensagens user-facing exige curadoria humana + tabela completa do MICROCOPY.md) | UX-PROGRESSION-01 |
