...
| 125i | **GAUNTLET-LOOP-PY-REF-FIX-01** | 25.0 Release | ALTA | PENDENTE (2026-05-19, segunda sessão; anti-débito descoberto durante GAUNTLET-FIXTURES-SANDBOX-01 — F2-03 e F2-06 em scripts/gauntlet/nyx_gauntlet.py linhas 2322-2325 e 2337-2340 assertam `'loop.py' in r.output` mas nyx/agent/loop.py foi convertido em pacote nyx/agent/loop/ por refactor anterior; spec propõe substituir alvo de `loop.py` para `parser.py` (arquivo estável presente desde início do projeto); linha 3401 NÃO é tocada — repo_map é fixture intencional de CTX-09 testando placeholder de prompt build; touches: 1 arquivo, 4 linhas; out-of-scope: refactor de loop/, mudanças em produção, P-07 falha pré-existente da fase proxy) | GAUNTLET-FIXTURES-SANDBOX-01 |
...
| 125l | **GAUNTLET-LOOP-PY-REF-FIX-01** | 25.1 Resiliência do gauntlet | MÉDIA | PENDENTE (anti-débito de GAUNTLET-FIXTURES-SANDBOX-01; F2-03 e F2-06 procuram nyx/agent/loop.py mas refactor anterior converteu em pacote nyx/agent/loop/_core.py + _iteration.py; recupera +2 falhas elevando pass-rate de 213/220 para 215/220) | GAUNTLET-FIXTURES-SANDBOX-01 |
