...
| 125dd | **MASTER-CLEANUP-02** | 25.meta Anti-débito de pipeline | BAIXA | PENDENTE (achado sistêmico durante tentativa de sprint-ciclo de SBOM-REGISTRY-01: ~20+ specs em dev-journey/06-sprints/concluidos/ ainda têm `**Status:** PENDENTE` no header, apesar de estarem arquivados como concluídos. Causa: SPRINT_ORDER-REFRESH-01 (2026-05-19) moveu arquivos sem atualizar header. Fix: script de batch ou Edit cirúrgico em ~20 arquivos. Touches: dev-journey/06-sprints/concluidos/*.md. Out-of-scope: spec aliases internos. Lista preliminar: SPRINT_ADR_021_DOC, SPRINT_ADR_022_DOC, SPRINT_AUDIT_01..06, SPRINT_AUDIT_EXT_01, SPRINT_AUDIT_FIX_01/02/03/05/06/07/08/09, SPRINT_BANNER_TOOLS_COUNT_01, SPRINT_BOOT_FIX_01, SPRINT_COCKPIT_01, e outros) | -- |
