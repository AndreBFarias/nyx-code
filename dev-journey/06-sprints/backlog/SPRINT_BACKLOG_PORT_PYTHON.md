...
real (28 modulos, 6500 LOC) e o TUI como referencia de comportamento.
...
**Referencia:** TUI README (arquitetura, 6 arquivos core, shim OpenAI)
...
| 2 | TUI shim (conceito) | `nyx/providers/openai_compat.py` |
