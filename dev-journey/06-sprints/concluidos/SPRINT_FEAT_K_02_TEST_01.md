# SPRINT FEAT-K-02-TEST-01 — Cobrir feature K-02 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-K-02-TEST-01
  title: "Cobrir feature K-02 (Tempo de warmup) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature K-02 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para K-02"
    - "Validação: '<90s'"
```
