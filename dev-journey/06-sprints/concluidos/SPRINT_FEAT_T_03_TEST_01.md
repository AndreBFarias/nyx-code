# SPRINT FEAT-T-03-TEST-01 — Cobrir feature T-03 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-T-03-TEST-01
  title: "Cobrir feature T-03 (Criar arquivo novo) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature T-03 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para T-03"
    - "Validação: 'Arquivo existe no disco após execução'"
```
