# SPRINT FEAT-T-02-TEST-01 — Cobrir feature T-02 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-T-02-TEST-01
  title: "Cobrir feature T-02 (Ler arquivo inexistente (graceful)) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature T-02 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para T-02"
    - "Validação: 'Erro informativo, sem crash'"
```
