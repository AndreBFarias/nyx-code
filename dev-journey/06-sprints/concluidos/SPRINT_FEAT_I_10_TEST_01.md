# SPRINT FEAT-I-10-TEST-01 — Cobrir feature I-10 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-I-10-TEST-01
  title: "Cobrir feature I-10 (Modo debug (--debug)) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature I-10 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para I-10"
    - "Validação: 'Logs detalhados ativados'"
```
