# SPRINT FEAT-K-05-TEST-01 — Cobrir feature K-05 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-K-05-TEST-01
  title: "Cobrir feature K-05 (TTFR - tool call com conteúdo (Write)) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature K-05 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para K-05"
    - "Validação: '<45s'"
```
