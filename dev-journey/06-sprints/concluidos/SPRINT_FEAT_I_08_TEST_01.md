# SPRINT FEAT-I-08-TEST-01 — Cobrir feature I-08 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-I-08-TEST-01
  title: "Cobrir feature I-08 (Desinstalação limpa) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature I-08 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para I-08"
    - "Validação: 'Remove tudo, mantém código fonte'"
```
