# SPRINT FEAT-K-06-TEST-01 — Cobrir feature K-06 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-K-06-TEST-01
  title: "Cobrir feature K-06 (Tokens por resposta (chat)) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature K-06 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para K-06"
    - "Validação: '30-100'"
```
