# SPRINT FEAT-T-01-TEST-01 — Cobrir feature T-01 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-T-01-TEST-01
  title: "Cobrir feature T-01 (Ler arquivo existente) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature T-01 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para T-01"
    - "Validação: 'Retorna conteúdo correto'"
```
