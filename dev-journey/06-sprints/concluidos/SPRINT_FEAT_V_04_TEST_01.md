# SPRINT FEAT-V-04-TEST-01 — Cobrir feature V-04 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-V-04-TEST-01
  title: "Cobrir feature V-04 (Citação de filósofo nos scripts) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature V-04 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para V-04"
    - "Validação: 'Presente no fim de cada arquivo'"
```
