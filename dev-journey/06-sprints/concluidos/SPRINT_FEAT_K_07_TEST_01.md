# SPRINT FEAT-K-07-TEST-01 — Cobrir feature K-07 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-K-07-TEST-01
  title: "Cobrir feature K-07 (Tokens por resposta (tool call)) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature K-07 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para K-07"
    - "Validação: '200-800'"
```
