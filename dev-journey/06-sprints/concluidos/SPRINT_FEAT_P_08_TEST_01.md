# SPRINT FEAT-P-08-TEST-01 — Cobrir feature P-08 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-P-08-TEST-01
  title: "Cobrir feature P-08 (Logging de requests/responses) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature P-08 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para P-08"
    - "Validação: 'Cada request logado com modelo, tools, resultado'"
```
