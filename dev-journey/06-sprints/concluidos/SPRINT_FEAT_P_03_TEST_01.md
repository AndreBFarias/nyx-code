# SPRINT FEAT-P-03-TEST-01 — Cobrir feature P-03 com teste no Gauntlet

## 0. SPEC

```yaml
sprint:
  id: FEAT-P-03-TEST-01
  title: "Cobrir feature P-03 (Injeção de num_gpu e num_ctx) com teste no Gauntlet"
  onda: 23
  ...
  acceptance_criteria:
    - "Feature P-03 ganha entry de teste no Gauntlet"
    - "REGISTRY.yaml passa a ter status verde ou vermelho (não desconhecido) para P-03"
    - "Validação: 'Options corretas no request'"
```
