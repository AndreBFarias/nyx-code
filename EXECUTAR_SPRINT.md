# Executar próxima sprint — SBOM-REGISTRY-02
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_SBOM_REGISTRY_02.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT SBOM-REGISTRY-02] BLOQUEADA: <motivo objetivo>

ID desta sprint: SBOM-REGISTRY-02
Arquivo: dev-journey/06-sprints/producao/SPRINT_SBOM_REGISTRY_02.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §SBOM-REGISTRY-02. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para SBOM-REGISTRY-02 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
