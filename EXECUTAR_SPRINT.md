# Executar próxima sprint — VISUAL-LAYOUT-01
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_VISUAL_LAYOUT_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT VISUAL-LAYOUT-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: VISUAL-LAYOUT-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_VISUAL_LAYOUT_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §VISUAL-LAYOUT-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para VISUAL-LAYOUT-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
