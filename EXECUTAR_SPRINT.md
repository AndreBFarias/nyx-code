# Executar próxima sprint — TUI-CSS-LUNA-ADOPT-01

> **Este arquivo é auto-atualizado por `scripts/update_next_sprint.py` após cada sprint concluída.**
> Copie o bloco abaixo e cole em uma session nova de Claude Opus 4.7. <!-- noqa-anonimato -->
> Restam **7** sprints PENDENTE(S) na fila.
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_TUI_CSS_LUNA_ADOPT_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT TUI-CSS-LUNA-ADOPT-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: TUI-CSS-LUNA-ADOPT-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_TUI_CSS_LUNA_ADOPT_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §TUI-CSS-LUNA-ADOPT-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para TUI-CSS-LUNA-ADOPT-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
