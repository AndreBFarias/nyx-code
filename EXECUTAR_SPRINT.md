# Executar próxima sprint — TUI-FIX-07A
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_TUI_FIX_07A.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT TUI-FIX-07A] BLOQUEADA: <motivo objetivo>

ID desta sprint: TUI-FIX-07A
Arquivo: dev-journey/06-sprints/producao/SPRINT_TUI_FIX_07A.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §TUI-FIX-07A. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para TUI-FIX-07A não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
