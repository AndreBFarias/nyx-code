# Executar próxima sprint — AUDIT-FIX-06
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_06.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT AUDIT-FIX-06] BLOQUEADA: <motivo objetivo>

ID desta sprint: AUDIT-FIX-06
Arquivo: dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_06.md
```
