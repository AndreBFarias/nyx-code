# Executar próxima sprint — AUDIT-FIX-09
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_09.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT AUDIT-FIX-09] BLOQUEADA: <motivo objetivo>

ID desta sprint: AUDIT-FIX-09
Arquivo: dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_09.md
```
