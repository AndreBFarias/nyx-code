# Executar próxima sprint — SPRINT_ORDER-OVERRIDE-FIX-01
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_SPRINT_ORDER_OVERRIDE_FIX_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT SPRINT_ORDER-OVERRIDE-FIX-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: SPRINT_ORDER-OVERRIDE-FIX-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_SPRINT_ORDER_OVERRIDE_FIX_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §SPRINT_ORDER-OVERRIDE-FIX-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para SPRINT_ORDER-OVERRIDE-FIX-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
