# Executar próxima sprint — MCP-SERVER-01
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_MCP_SERVER_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT MCP-SERVER-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: MCP-SERVER-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_MCP_SERVER_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §MCP-SERVER-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para MCP-SERVER-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
