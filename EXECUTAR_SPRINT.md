# Executar próxima sprint — LANG-PROMPT-ACENT-01
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_LANG_PROMPT_ACENT_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT LANG-PROMPT-ACENT-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: LANG-PROMPT-ACENT-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_LANG_PROMPT_ACENT_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §LANG-PROMPT-ACENT-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para LANG-PROMPT-ACENT-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
