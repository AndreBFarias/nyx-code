# Executar próxima sprint — DEBT-01
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_DEBT_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT DEBT-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: DEBT-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_DEBT_01.md
```
