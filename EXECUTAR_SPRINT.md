# Executar próxima sprint — AUDIT-FIX-07
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_07.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT AUDIT-FIX-07] BLOQUEADA: <motivo objetivo>

ID desta sprint: AUDIT-FIX-07
Arquivo: dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_07.md
```
