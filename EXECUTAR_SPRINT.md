# Executar próxima sprint — DEBT-05
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_DEBT_05.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT DEBT-05] BLOQUEADA: <motivo objetivo>

ID desta sprint: DEBT-05
Arquivo: dev-journey/06-sprints/producao/SPRINT_DEBT_05.md
```
