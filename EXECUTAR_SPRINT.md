# Executar próxima sprint — AUDIT-FIX-08
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_08.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT AUDIT-FIX-08] BLOQUEADA: <motivo objetivo>

ID desta sprint: AUDIT-FIX-08
Arquivo: dev-journey/06-sprints/producao/SPRINT_AUDIT_FIX_08.md
```
