# Executar próxima sprint — DEBT-04
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_DEBT_04.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT DEBT-04] BLOQUEADA: <motivo objetivo>

ID desta sprint: DEBT-04
Arquivo: dev-journey/06-sprints/producao/SPRINT_DEBT_04.md
```
