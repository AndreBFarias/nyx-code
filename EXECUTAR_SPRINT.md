# Executar próxima sprint — COCKPIT-WEB-REDESIGN-02
...
> Restam **25** sprints PENDENTE(S) na fila.
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_COCKPIT_WEB_REDESIGN_02.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT COCKPIT-WEB-REDESIGN-02] BLOQUEADA: <motivo objetivo>

ID desta sprint: COCKPIT-WEB-REDESIGN-02
Arquivo: dev-journey/06-sprints/producao/SPRINT_COCKPIT_WEB_REDESIGN_02.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §COCKPIT-WEB-REDESIGN-02. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para COCKPIT-WEB-REDESIGN-02 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
