# Executar próxima sprint — COCKPIT-WEB-REDESIGN-01
...
> Restam **26** sprints PENDENTE(S) na fila.
...
```
Execute /home/andrefarias/Desenvolvimento/Nyx-Code/dev-journey/06-sprints/producao/SPRINT_COCKPIT_WEB_REDESIGN_01.md.
...
Se qualquer passo falhar, reporte:
    [SPRINT COCKPIT-WEB-REDESIGN-01] BLOQUEADA: <motivo objetivo>

ID desta sprint: COCKPIT-WEB-REDESIGN-01
Arquivo: dev-journey/06-sprints/producao/SPRINT_COCKPIT_WEB_REDESIGN_01.md
```
...
> Fonte canônica: `dev-journey/08-templates/GAMBIARRAS_POR_SPRINT.md` §COCKPIT-WEB-REDESIGN-01. O bloco abaixo é renovado a cada `python scripts/update_next_sprint.py`.

(seção específica para COCKPIT-WEB-REDESIGN-01 não encontrada em GAMBIARRAS_POR_SPRINT.md; ler catálogo universal e matriz geral)
