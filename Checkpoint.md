...
- **Último commit:** próximo será `feat(NYX-NO-HALLUCINATE-TOOL-01)`. Anteriores: `c3cf033 feat(NYX-AUTO-APPROVE-01)`, `5732120 fix(TUI-INPUT-HEIGHT)`, `f223c3e fix(COCKPIT-LIFECYCLE-FIX-01)`.
- **Próxima ação:** continuar sprints anti-débito em `producao/` (NYX-NO-HALLUCINATE-TOOL-01 saiu; COCKPIT-ACENTUACAO-FIX-01, MASTER-ACENTUACAO-FIX-01, GAMBIARRAS-ACENTUACAO-FIX-01 e demais continuam).
